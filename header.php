...
<head>
  ...
  <?php
    ...
    // Import three.js if front page
    if (is_front_page()):
  ?>
  <script type="module" src="<?php echo get_template_directory_uri() . '/assets/js/ani/index.js'; ?>"></script>
  <?php endif; ?>
</head>
<body <?php body_class(['relative w-screen max-w-[1550px] mx-auto']);?>>
  <?php
    ...
    ?>
  <header class="relative w-full md:px-3 mx-auto top-0 flex flex-wrap sm:justify-start sm:flex-nowrap bg-transparent text-sm py-3">
    <nav class="w-full flex flex-wrap items-center <?php echo esc_attr(!is_front_page() ?  "justify-between" : "justify-end"); ?>">
      ...
      <div class="hidden w-screen nav:w-[36.95rem] nav:flex nav:flex-row nav:justify-end nav:border-b-2 nav:rounded-xs nav:border-b-neutral-100" id="navbar-default">
        <ul class="font-blinker-semibold flex max-nav:flex-col py-5 px-6 text-lg tracking-widest nav:p-0 nav:me-2 border-b-1 border-b-gray-100 rounded-xs nav:flex-row space-y-4 nav:space-x-8 rtl:space-x-reverse nav:mt-0 nav:border-0 nav:w-auto">
          <li class="nav:mb-0">
            <a href="<?php echo get_post_type_archive_link('post'); ?>" class="block md:pt-0 md:pb-0 py-4 px-3 text-black nav:text-gray-300 text-center bg-gray-300 rounded-xs border-transparent nav:rounded-sm border-2 hover:border-neutral-200 hover:bg-gray-400/10 hover:text-gray-300 focus:outline-2 focus:outline-offset-2 focus:outline-neutral-200 transition-colors duration-400 md:bg-transparent">Blog</a>
          </li>
          <li class="nav:mb-0">
            <a href="<?php echo esc_url(get_site_url() . '/portfolio'); ?>" class="block md:pt-0 md:pb-0 py-4 px-3 text-black nav:text-gray-300 text-center bg-gray-300 hover:text-gray-300 rounded-xs border-transparent md:rounded-sm border-2 hover:border-neutral-200 hover:bg-gray-400/10 focus:outline-2 focus:outline-offset-2 focus:outline-neutral-200 transition-colors duration-400 md:bg-transparent">Portfolio</a>
          </li>
          <li class="nav:mb-0">
            <a href="<?php echo esc_url(get_site_url() . '/about'); ?>" class="block md:pt-0 md:pb-0 py-4 px-3 text-black nav:text-gray-300 text-center bg-gray-300 rounded-xs border-transparent md:rounded-sm border-2 hover:border-neutral-200 hover:bg-gray-400/10 hover:text-gray-300 focus:outline-2 focus:outline-offset-2 focus:outline-neutral-200 transition-colors duration-400 md:bg-transparent">About</a>
          </li>
          <li class="nav:mb-0">
            <a href="<?php echo esc_url(get_site_url() . '/contact'); ?>" class="block md:pt-0 md:pb-0 py-4 px-3 text-white text-center bg-old-gold/75 rounded-xs md:rounded-sm border-2 border-transparent hover:border-neutral-200 hover:bg-gray-400/10 focus:outline-2 focus:outline-offset-2 focus:outline-neutral-200 transition-colors duration-400">Contact</a>
          </li>
        </ul>
      </div>
    </nav>
